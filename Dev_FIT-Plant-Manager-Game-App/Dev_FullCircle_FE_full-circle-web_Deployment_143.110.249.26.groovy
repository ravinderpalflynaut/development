pipeline {
    ...
    environment {
        REPONAME              = 'fit-plant-manager-game-app'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/FIT-Plant-Manager-Game-App.git"
        GIT_BRANCH            = 'main'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/fit-plant-manager-game-app-dev/fit-plant-manager-game-app'
