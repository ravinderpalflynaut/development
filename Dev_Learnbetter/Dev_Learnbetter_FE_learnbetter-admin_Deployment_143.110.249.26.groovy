pipeline {
    ...
    environment {
        REPONAME              = 'learnbetter-admin'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/learnbetter-admin.git"
        GIT_BRANCH            = 'development'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/learnbetter-dev/learnbetter-admin'
