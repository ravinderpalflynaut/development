pipeline {
    ...
    environment {
        REPONAME              = 'learnbetter-user'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/learnbetter-user.git"
        GIT_BRANCH            = 'development'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/learnbetter-dev/learnbetter-user'
