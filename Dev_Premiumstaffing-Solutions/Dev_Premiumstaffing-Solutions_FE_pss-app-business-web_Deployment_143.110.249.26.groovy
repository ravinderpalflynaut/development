pipeline {
    ...
    environment {
        REPONAME              = 'pss-app-business-web'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/pss-app-business-web.git"
        GIT_BRANCH            = 'development'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/premierstaffingsolution-dev/pss-app-business-web'
