pipeline {
    ...
    environment {
        REPONAME              = 'pss-app-backend'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/pss-app-backend.git"
        GIT_BRANCH            = 'staging'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/premierstaffingsolution-dev/pss-app-backend'
