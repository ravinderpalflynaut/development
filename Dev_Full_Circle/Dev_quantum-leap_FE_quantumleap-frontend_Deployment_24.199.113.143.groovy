pipeline {
    ...
    environment {
        REPONAME              = 'quantumleap-frontend'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/quantumleap-frontend.git"
        GIT_BRANCH            = 'master'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/quantumleap-dev/quantumleap-frontend'
