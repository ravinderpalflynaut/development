pipeline {
    ...
    environment {
        REPONAME              = 'future-capacity-frontend'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/future-capacity-frontend.git"
        GIT_BRANCH            = 'main'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/future-capacity-dev/future-capacity-frontend'
