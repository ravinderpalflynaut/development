pipeline {
    ...
    environment {
        REPONAME              = 'assembly-planner-web'
        GIT_CREDENTIALS_ID    = 'Jenkins-Git-Cred'
        GIT_REPO              = "https://github.com/FlyNaut-Dev/assembly-planner-web.git"
        GIT_BRANCH            = 'development'

        DOCKER_HUB_REPO       = 'hub.flynautstaging.com/assembly-planner-dev/assembly-planner-web'
